    ...
    schema = pa.DataFrameSchema(
        {
            ...
            "queue": pa.Column(str),
            # German split in the source dataset ships without ticket types (13k rows,
            # including 100% of critical/very_low) — nulls are legitimate at the raw boundary.
            "type": pa.Column(str, nullable=True),
            "language": pa.Column(str),
            "priority": pa.Column(str, checks=pa.Check.isin(["critical", "high", "low", "medium", "very_low"])),
    ...
    schema = pa.DataFrameSchema(
        {
            ...
            "type": pa.Column(str),
            "language": pa.Column(str),
            "priority": pa.Column(int, checks=pa.Check.isin([0, 1, 2, 3, 4])),
